...
public class ContractSamples {
	...
	public static Contract SimpleFuture(String symbol, String expireDate) {//Use this class for YM
		//! [futcontract]
		Contract contract = new Contract();
	...
	public static Contract FutureWithLocalSymbol(String symbol,String exchange) { //Use this class for ES, NQ, RTY(GLOBEX) && GC(NYMEX) && VX(CFE)
		//! [futcontract_local_symbol]
		Contract contract = new Contract();
		contract.localSymbol(symbol);//H:Mar,M:Jun,U:Sep, Z:Dec
		contract.secType("FUT");
		contract.currency("USD");
